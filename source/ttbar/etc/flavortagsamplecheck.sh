...
basename=/unix/lc/sohail/data/gridreco/rv01-19-05-p01.sv01-19-05-p01.mILD_l5_o1_v02.E500-TDR_ws.I1086;
for file in ${basename}*;

do 
 echo ${file}
    cat > samplecheckflavortagging.xml << EOF
  ...
  <parameter name="LCIOOutputFile" type="string"> ${file//.slci*/_flavortag}</parameter>
...
Marlin  samplecheckflavortagging.xml
  n=$((n+1));  
